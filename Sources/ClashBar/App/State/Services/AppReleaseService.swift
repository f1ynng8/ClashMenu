...
enum AppReleaseService {
    private static let latestReleaseURL = URL(string: "https://api.github.com/repos/f1ynng8/ClashMenu/releases/latest")!
    ...
    static func fetchLatestRelease(currentVersion: String) async throws -> AppReleaseInfo {
        ...
        request.setValue("ClashMenu/\(currentVersion)", forHTTPHeaderField: "User-Agent")
