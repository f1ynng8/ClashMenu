...
extension AppState {
    ...
    func startConfigDirectoryMonitoringIfNeeded() {
        ...
        _ = self.configManager.reloadConfigs()
    ...
    private func handleConfigDirectoryChangesIfNeeded() async {
        ...
        let previousSelectedPath = self.configManager.selectedConfig?.path
        _ = self.configManager.reloadConfigs()
    ...
    private func currentConfigFileSignatureSnapshot() -> [String: String] {
        ...
        for fileURL in self.configManager.availableConfigs {
    ...
    private func syncSelectedConfigStateForMonitoring() -> String? {
        guard let selected = self.configManager.selectedConfig else {
