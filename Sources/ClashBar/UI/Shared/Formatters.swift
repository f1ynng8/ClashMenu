...
enum ValueFormatter {
    private static let timestampFormatterKey = "clashmenu.formatter.timestamp"
    private static let timestampCache = TimestampCacheBox()

    private static let iso8601WithFractionalKey = "clashmenu.formatter.iso8601.fractional"
    private static let iso8601BasicKey = "clashmenu.formatter.iso8601.basic"
